...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TranslateGlossaryBody', function() {
      beforeEach(function() {
        instance = new NeuralSeek.TranslateGlossaryBody();
      });

      it('should create an instance of TranslateGlossaryBody', function() {
        // TODO: update the code to test TranslateGlossaryBody
        expect(instance).to.be.a(NeuralSeek.TranslateGlossaryBody);
      });
